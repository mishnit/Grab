...
func (*PostProductRequest) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{1} }
...
func (*PostProductResponse) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{2} }
...
func (*GetProductResponse) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{4} }
...
func (c *catalogServiceClient) PostProduct(ctx context.Context, in *PostProductRequest, opts ...grpc.CallOption) (*PostProductResponse, error) {
	...
	err := grpc.Invoke(ctx, "/pb.CatalogService/PostProduct", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *catalogServiceClient) GetProduct(ctx context.Context, in *GetProductRequest, opts ...grpc.CallOption) (*GetProductResponse, error) {
	...
	err := grpc.Invoke(ctx, "/pb.CatalogService/GetProduct", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *catalogServiceClient) GetProducts(ctx context.Context, in *GetProductsRequest, opts ...grpc.CallOption) (*GetProductsResponse, error) {
	...
	err := grpc.Invoke(ctx, "/pb.CatalogService/GetProducts", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
